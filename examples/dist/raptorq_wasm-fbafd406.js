...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === 'undefined') {
    module_or_path = new URL('raptorq_wasm_bg.wasm', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('raptorq_wasm-fbafd406.js', document.baseURI).href)));
  }
...
exports.WasmEncoder = WasmEncoder;
exports.default = __wbg_init;
//# sourceMappingURL=raptorq_wasm-fbafd406.js.map
