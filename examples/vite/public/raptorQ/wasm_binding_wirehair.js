...
export class WasmDecoder {
    ...
    constructor(k, block_size) {
        const ret = wasm.wasmdecoder_new(k, block_size);
     ...
     * @returns {boolean}
     */
    add_symbol(symbol_id, data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmdecoder_add_symbol(this.__wbg_ptr, symbol_id, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_decoded() {
        const ret = wasm.wasmdecoder_is_decoded(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    get_decoded() {
        const ret = wasm.wasmdecoder_get_decoded(this.__wbg_ptr);
        return ret;
    }
}
...
export class WasmEncoder {
     ...
     * @param {number} block_size
     */
    constructor(data, k, block_size) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmencoder_new(ptr0, len0, k, block_size);
        this.__wbg_ptr = ret >>> 0;
     ...
     */
    encode(symbol_id) {
        const ret = wasm.wasmencoder_encode(this.__wbg_ptr, symbol_id);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_k() {
        const ret = wasm.wasmencoder_get_k(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    get_block_size() {
        const ret = wasm.wasmencoder_get_block_size(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('wasm_binding_wirehair_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
